...
Не сработает первый вариант. Так как он объявлен с помощью Function Declaration, через let. А переменная объвленная через let не может быть вызвана до ее объявления. В то время как второй вариант объявлен через Funtion Declaration и они могут быть вываны и любого участка кода.
